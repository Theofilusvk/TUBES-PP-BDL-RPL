	...
	class ALWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
				ALAccount::addAccount($this->settings, '915f25b4d196dcfe4a48b3d7c15677a1', '2eb81e0dd3b144f996288a4522dd7fcf');
		ALAccount::updateApiPublicKey($this->settings, '915f25b4d196dcfe4a48b3d7c15677a1');
			}
