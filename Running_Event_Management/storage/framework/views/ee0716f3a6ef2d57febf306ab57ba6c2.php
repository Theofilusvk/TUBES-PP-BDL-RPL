...
<?php $__env->startSection('header_title', 'Leaderboards'); ?>
        ...
        <div class="flex flex-col md:flex-row items-end justify-center gap-6 md:gap-8 pb-4">
                ...
                <div class="order-2 md:order-1 w-full md:w-72 bg-white dark:bg-gray-800 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none border border-gray-100 dark:border-gray-700 relative flex flex-col items-center p-6 pb-8 transform hover:-translate-y-2 transition-transform duration-300 group">
                    ...
                    <div class="w-20 h-20 rounded-full p-1 bg-gradient-to-tr from-slate-300 to-slate-100 mb-3 mt-4 group-hover:scale-105 transition-transform">
                        <img alt="Runner" class="w-full h-full rounded-full object-cover border-2 border-white dark:border-gray-800" src="<?php echo e($runner2->Gambar ?? 'https://ui-avatars.com/api/?name='.urlencode($runner2->NamaLengkap).'&background=random'); ?>"/>
                    </div>
                    <div class="text-center w-full">
                        <div class="font-bold text-lg text-gray-900 dark:text-white truncate"><?php echo e($runner2->NamaLengkap); ?></div>
                        <div class="text-xs text-gray-500 mb-4 flex items-center justify-center gap-1.5">
                            <?php if($iconFile2): ?>
                                <img src="<?php echo e(asset('assets/cities/'.$iconFile2)); ?>" class="w-5 h-5 object-contain" alt="<?php echo e($runner2->Kota); ?>" title="<?php echo e($runner2->Kota); ?>">
                            <?php else: ?>
                                <span class="material-icons text-[14px] text-blue-500">place</span> 
                            <?php endif; ?>
                            <?php echo e($runner2->Kota ?? 'Independent'); ?>

                        </div>
                        <div class="w-full h-px bg-gray-100 dark:bg-gray-700 mb-4"></div>
                        <div class="flex justify-between items-center px-4">
                            <div class="text-xs text-gray-400 uppercase"><?php echo e($isSpeedRank ? 'Time' : 'Distance'); ?></div>
                            <div class="text-2xl font-display font-bold text-gray-700 dark:text-gray-200">
                                <?php if($isSpeedRank): ?>
                                    <?php echo e($runner2->WaktuFinish); ?>

                                <?php else: ?>
                                    <?php echo e(number_format($runner2->TotalDist, 0)); ?> <span class="text-xs font-sans font-medium text-gray-400">KM</span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
            ...
            <?php if($topRunners->count() >= 1): ?>
                ...
                <div class="order-1 md:order-2 w-full md:w-80 bg-white dark:bg-gray-800 text-gray-900 dark:text-white rounded-2xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border-4 border-yellow-400/50 relative flex flex-col items-center p-6 pb-10 z-10 transform scale-105 hover:-translate-y-3 transition-transform duration-300">
                    ...
                    <div class="w-28 h-28 rounded-full p-1.5 bg-gradient-to-tr from-yellow-400 via-yellow-200 to-yellow-500 mb-3 mt-8 shadow-lg">
                        <img alt="Runner" class="w-full h-full rounded-full object-cover border-4 border-white dark:border-gray-800" src="<?php echo e($runner1->Gambar ?? 'https://ui-avatars.com/api/?name='.urlencode($runner1->NamaLengkap).'&background=random'); ?>"/>
                    </div>
                    <div class="text-center w-full">
                        <div class="font-bold text-2xl mb-1 text-gray-900 dark:text-white"><?php echo e($runner1->NamaLengkap); ?></div>
                        <div class="text-xs text-gray-500 dark:text-gray-400 font-bold mb-4 flex items-center justify-center gap-1.5 uppercase tracking-widest">
                            ...
                            <?php if($iconFile1): ?>
                                <img src="<?php echo e(asset('assets/cities/'.$iconFile1)); ?>" class="w-5 h-5 object-contain" alt="<?php echo e($runner1->Kota); ?>" title="<?php echo e($runner1->Kota); ?>">
                            <?php endif; ?>
                            <?php echo e($runner1->Kota ?? 'Independent'); ?>

                        </div>
                        <div class="w-full h-px bg-gray-100 dark:bg-gray-700 mb-4"></div>
                        <div class="flex justify-between items-end px-2">
                            <div class="text-xs text-gray-400 uppercase mb-1"><?php echo e($isSpeedRank ? 'Finish Time' : 'Total Distance'); ?></div>
                            <div class="text-4xl font-display font-bold text-gray-800 dark:text-white">
                                <?php if($isSpeedRank): ?>
                                    <?php echo e($runner1->WaktuFinish); ?>

                                <?php else: ?>
                                    <?php echo e(number_format($runner1->TotalDist, 0)); ?> <span class="text-sm font-sans font-medium text-gray-400">KM</span>
                                <?php endif; ?>
                            </div>
                        </div>
            ...
            <?php if($topRunners->count() >= 3): ?>
                ...
                <div class="order-3 md:order-3 w-full md:w-72 bg-white dark:bg-gray-800 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none border border-gray-100 dark:border-gray-700 relative flex flex-col items-center p-6 pb-8 transform hover:-translate-y-2 transition-transform duration-300 group">
                    ...
                    <div class="w-20 h-20 rounded-full p-1 bg-gradient-to-tr from-orange-300 to-orange-100 mb-3 mt-4 group-hover:scale-105 transition-transform">
                        <img alt="Runner" class="w-full h-full rounded-full object-cover border-2 border-white dark:border-gray-800" src="<?php echo e($runner3->Gambar ?? 'https://ui-avatars.com/api/?name='.urlencode($runner3->NamaLengkap).'&background=random'); ?>"/>
                    </div>
                    <div class="text-center w-full">
                        <div class="font-bold text-lg text-gray-900 dark:text-white truncate"><?php echo e($runner3->NamaLengkap); ?></div>
                        <div class="text-xs text-gray-500 mb-4 flex items-center justify-center gap-1.5">
                            <?php if($iconFile3): ?>
                                <img src="<?php echo e(asset('assets/cities/'.$iconFile3)); ?>" class="w-5 h-5 object-contain" alt="<?php echo e($runner3->Kota); ?>" title="<?php echo e($runner3->Kota); ?>">
                            <?php else: ?>
                                <span class="material-icons text-[14px] text-orange-500">place</span> 
                            <?php endif; ?>
                            <?php echo e($runner3->Kota ?? 'Independent'); ?>
                        ...
                        <div class="flex justify-between items-center px-4">
                            ...
                            <div class="text-2xl font-display font-bold text-gray-700 dark:text-gray-200">
                                <?php if($isSpeedRank): ?>
                                    <?php echo e($runner3->WaktuFinish); ?>

                                <?php else: ?>
                                    <?php echo e(number_format($runner3->TotalDist, 0)); ?> <span class="text-xs font-sans font-medium text-gray-400">KM</span>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
    ...
    <div class="bg-white dark:bg-gray-800 p-4 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 flex flex-col xl:flex-row gap-4 justify-between items-center sticky top-0 z-20">
        <div class="flex flex-wrap items-center gap-3 w-full xl:w-auto">
            ...
            <select class="form-select pl-3 pr-10 py-2 text-sm rounded-lg border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-700 dark:text-gray-200 focus:ring-primary focus:border-primary shadow-sm" onchange="window.location.href='?category='+this.value">
                <option value="All" <?php echo e($category == 'All' ? 'selected' : ''); ?>>All Categories (Distance)</option>
                <option value="5K" <?php echo e($category == '5K' ? 'selected' : ''); ?>>5K Fun Run (Fastest)</option>
                <option value="10K" <?php echo e($category == '10K' ? 'selected' : ''); ?>>10K Race (Fastest)</option>
                <option value="21K" <?php echo e($category == '21K' ? 'selected' : ''); ?>>Half Marathon (Fastest)</option>
                <option value="42K" <?php echo e($category == '42K' ? 'selected' : ''); ?>>Marathon (Fastest)</option>
            </select>
        </div>
            ...
            <table class="w-full text-left border-collapse">
                <thead>
                    <tr class="bg-gray-50/80 dark:bg-gray-700/50 text-gray-500 dark:text-gray-400 text-xs uppercase tracking-wider border-b border-gray-200 dark:border-gray-700">
                        ...
                        <th class="px-6 py-4 font-bold hidden sm:table-cell text-right"><?php echo e($isSpeedRank ? 'Pace' : 'Elev. Gain'); ?></th>
                        <th class="px-6 py-4 font-bold text-right text-primary">Total Distance</th>
                    </tr>
                </thead>
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $rankings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $runner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-blue-50/50 dark:hover:bg-gray-700/30 transition-colors group">
                        <td class="px-6 py-4 text-center font-display font-bold text-gray-700 dark:text-gray-300 text-lg group-hover:text-primary transition-colors">
                            <?php echo e($rankings->firstItem() + $index); ?>

                        </td>
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                <div class="relative">
                                    <img class="w-10 h-10 rounded-full bg-gray-200 object-cover" src="<?php echo e($runner->Gambar ?? 'https://ui-avatars.com/api/?name='.urlencode($runner->NamaLengkap).'&background=random'); ?>"/>
                                </div>
                                <div>
                                    <span class="font-bold text-gray-900 dark:text-white block"><?php echo e($runner->NamaLengkap); ?></span>
                                    <div class="flex items-center gap-2 text-xs text-gray-500">
                                        <span><?php echo e('@' . $runner->Username); ?></span>
                                        <?php if(isset($runner->NomorBIB)): ?>
                                            <span class="px-1.5 py-0.5 rounded bg-gray-100 dark:bg-gray-700 font-mono text-gray-600 dark:text-gray-300">BIB: <?php echo e($runner->NomorBIB); ?></span>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            </div>
                        ...
                        <td class="px-6 py-4 hidden md:table-cell text-gray-500 dark:text-gray-400">
                            <div class="flex items-center gap-2">
                                ...
                                ?>
                                <?php if($rowIconFile): ?>
                                    <img src="<?php echo e(asset('assets/cities/'.$rowIconFile)); ?>" class="w-5 h-5 object-contain" alt="<?php echo e($runner->Kota); ?>" title="<?php echo e($runner->Kota); ?>">
                                <?php endif; ?>
                                <?php echo e($runner->Kota ?? '-'); ?>

                            </div>
                        </td>
                        <td class="px-6 py-4 hidden lg:table-cell text-right text-gray-900 dark:text-white font-medium">
                            <?php echo e($isSpeedRank ? '-' : $runner->TotalRace); ?>

                        </td>
                        <td class="px-6 py-4 hidden sm:table-cell text-right font-mono <?php echo e($isSpeedRank ? 'text-emerald-600 dark:text-emerald-400 font-medium' : 'text-gray-600 dark:text-gray-400'); ?>">
                             <?php echo e($isSpeedRank ? ($runner->Pace ?? 'N/A') : '--'); ?>

                        </td>
                        <td class="px-6 py-4 text-right font-display font-bold text-gray-900 dark:text-white text-lg">
                            <?php if($isSpeedRank): ?>
                                <?php echo e($runner->WaktuFinish); ?>

                            <?php else: ?>
                                <?php echo e(number_format($runner->TotalDist, 0)); ?> <span class="text-xs text-gray-400 font-sans font-normal">KM</span>
                            <?php endif; ?>
                        </td>
                    </tr>
                ...
                <tr class="bg-gradient-to-r from-primary to-blue-600 dark:from-blue-900 dark:to-slate-900">
                    ...
                    <td class="px-6 py-3 text-center w-20">
                        <div class="flex flex-col items-center">
                            ...
                            <span class="font-display font-bold text-2xl">#<?php echo e($userStats->rank); ?></span>
                        </div>
                    </td>
                    <td class="px-6 py-3 min-w-[200px]">
                        <div class="flex items-center gap-3">
                            <img class="w-10 h-10 rounded-full border-2 border-white/30" src="<?php echo e(Auth::user()->Gambar ?? 'https://ui-avatars.com/api/?name='.urlencode(Auth::user()->NamaLengkap).'&background=random'); ?>"/>
                            <div>
                                <span class="font-bold block text-lg">You</span>
                                <span class="text-xs text-blue-100 flex items-center gap-1">
                                    <span class="material-icons text-[10px]">arrow_upward</span> Top <?php echo e($userStats->percentile); ?>%
                                </span>
                            </div>
                        </div>
                    </td>
                    <td class="px-6 py-3 hidden md:table-cell text-blue-100 font-medium"><?php echo e(Auth::user()->Kota ?? 'Runner'); ?></td>
                    <td class="px-6 py-3 hidden lg:table-cell text-right font-bold text-lg"><?php echo e($userStats->total_events); ?></td>
                    <td class="px-6 py-3 hidden sm:table-cell text-right font-mono text-blue-100">-</td>
                    <td class="px-6 py-3 text-right">
                        <div class="flex flex-col items-end">
                            <span class="font-display font-bold text-white text-xl"><?php echo e($userStats->display_value); ?></span>
                            <span class="text-[10px] uppercase opacity-75"><?php echo e($userStats->label); ?></span>
                        </div>
                    </td>
                    <?php else: ?>
                    <td colspan="6" class="px-6 py-4 text-center">
                        <div class="flex items-center justify-center gap-4">
                            ...
                            <a href="<?php echo e(route('dashboard.events')); ?>" class="ml-4 px-4 py-2 bg-white text-primary font-bold rounded-lg text-sm hover:bg-gray-100 transition-colors">Find a Race</a>
                        </div>
                    </td>
                    <?php endif; ?>
                </tr>
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Kuliah\Semester 3\Rekayasa Perangkat Lunak\TUBES-PP-BDL-RPL\Running_Event_Management\resources\views/dashboard/leaderboards/index.blade.php ENDPATH**/ ?>