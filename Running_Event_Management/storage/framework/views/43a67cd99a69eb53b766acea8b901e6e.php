                        ...
                        <tr class="hover:bg-white/[0.02] transition-colors group">
                            ...
                            <td class="px-8 py-5">
                             ...
                             <td class="px-8 py-5 text-right">
                                ...
                                <?php else: ?>
                                    <button onclick="openModal('<?php echo e($txn->PembayaranID); ?>', '<?php echo e($txn->BuktiTransfer ?? ''); ?>')" class="bg-surface-dark border border-border-dark hover:border-primary text-slate-300 hover:text-white px-3 py-1 rounded-lg text-[10px] uppercase font-bold tracking-widest transition-all">
                                        Inspect
                                    </button>
                                <?php endif; ?>
                            </td>
