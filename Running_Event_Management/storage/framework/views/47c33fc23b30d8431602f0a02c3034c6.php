...
<?php $__env->startSection('header_title', 'Results & Timing'); ?>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div class="bg-white dark:bg-card-dark p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm flex items-center gap-4">
            ...
            <div>
                ...
                <div class="text-2xl font-bold text-gray-900 dark:text-white flex items-baseline gap-2">
                    <?php echo e($personalBest->TimeDisplay ?? '--:--:--'); ?>

                    <span class="text-xs font-normal text-gray-500">
                        (<?php echo e($personalBest->NamaEvent ?? 'No Data'); ?> - <?php echo e($personalBest->NamaKategori ?? ''); ?>)
                    </span>
                </div>
                <div class="text-xs text-green-600 font-medium mt-1">Fastest Pace: <?php echo e($pbPaceFormatted); ?>/km</div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-card-dark p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm flex items-center gap-4">
            ...
            <div>
                ...
                <div class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($totalRaces); ?> <span class="text-sm font-normal text-gray-500">Races</span></div>
        ...
        <div class="bg-white dark:bg-card-dark p-6 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm flex items-center gap-4">
            ...
            <div>
                ...
                <div class="text-2xl font-bold text-gray-900 dark:text-white"><?php echo e($avgPace); ?> <span class="text-sm font-normal text-gray-500">/km</span></div>
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                <div class="h-10 w-10 rounded-lg bg-gray-200 overflow-hidden">
                                    <img src="<?php echo e($res->GambarEvent ?? 'https://placehold.co/100'); ?>" alt="Event" class="w-full h-full object-cover">
                                </div>
                                <div>
                                    <div class="font-bold text-gray-900 dark:text-white"><?php echo e($res->NamaEvent); ?></div>
                                    <div class="text-xs"><?php echo e($res->NamaKategori); ?></div>
                                </div>
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <?php echo e(\Carbon\Carbon::parse($res->EventDate ?? $res->TanggalPendaftaran)->format('M d, Y')); ?>

                        </td>
                        <td class="px-6 py-4">
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300">
                                <?php echo e($res->Jarak); ?>

                            </span>
                        </td>
                        <td class="px-6 py-4 font-mono font-medium text-gray-900 dark:text-white">
                            <?php echo e($res->WaktuFinish); ?>

                        </td>
                        <td class="px-6 py-4 font-mono text-sm text-emerald-600 dark:text-emerald-400 font-medium">
                            <?php echo e($res->Pace ?? 'N/A'); ?>

                        </td>
                        <td class="px-6 py-4 text-center">
                            <span class="font-bold text-gray-900 dark:text-white">#<?php echo e($res->PeringkatUmum); ?></span>
                        </td>
                        <td class="px-6 py-4 text-center">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Kuliah\Semester 3\Rekayasa Perangkat Lunak\TUBES-PP-BDL-RPL\Running_Event_Management\resources\views/dashboard/results/index.blade.php ENDPATH**/ ?>