...
<span class="material-symbols-outlined text-white group-hover:text-accent">dashboard</span>
...
<span class="material-symbols-outlined group-hover:text-accent">groups</span>
...
<a href="{{ route('login') }}" class="flex-1 py-4 text-center font-medium text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-800 transition-all">Sign In</a>
<a href="{{ route('register') }}" class="flex-1 py-4 text-center font-bold text-primary border-b-2 border-primary bg-blue-50/50 dark:bg-blue-900/20 dark:text-blue-400 transition-all">Sign Up</a>
</div>
...
<button class="w-full inline-flex justify-center items-center py-2.5 px-4 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-white dark:bg-gray-700 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
<svg class="h-5 w-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
<path d="M12.545,10.239v3.821h5.445c-0.712,2.315-2.647,3.972-5.445,3.972c-3.332,0-6.033-2.701-6.033-6.032s2.701-6.032,6.033-6.032c1.498,0,2.866,0.549,3.921,1.453l2.814-2.814C17.503,2.988,15.139,2,12.545,2C7.021,2,2.543,6.477,2.543,12s4.478,10,10.002,10c8.396,0,10.249-7.85,9.426-11.748L12.545,10.239z"></path>
</svg>
<span class="text-xs sm:text-sm">Sign up with Google</span>
</button>
<button class="w-full inline-flex justify-center items-center py-2.5 px-4 border border-gray-300 dark:border-gray-600 rounded-lg shadow-sm bg-white dark:bg-gray-700 text-sm font-medium text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
...
<span class="text-xs sm:text-sm">Sign up with Facebook</span>
</button>
</div>
...
<span class="px-3 bg-white dark:bg-card-dark rounded-full text-gray-500 dark:text-gray-400 text-xs font-medium uppercase tracking-wide">
...
<input class="block w-full pl-10 pr-3 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 focus:ring-primary focus:border-primary sm:text-sm text-gray-900 dark:text-white @error('name') border-red-500 @enderror" id="fullname" name="name" placeholder="John Doe" required="" type="text" value="{{ old('name') }}"/>
</div>
...
<input class="block w-full pl-10 pr-3 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 focus:ring-primary focus:border-primary sm:text-sm text-gray-900 dark:text-white @error('email') border-red-500 @enderror" id="signup-email" name="email" placeholder="runner@kalcer.id" required="" type="email" value="{{ old('email') }}"/>
</div>
...
<input class="block w-full pl-10 pr-3 py-2.5 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-800 focus:ring-primary focus:border-primary sm:text-sm text-gray-900 dark:text-white @error('password') border-red-500 @enderror" id="signup-password" name="password" placeholder="Min. 8 characters" required="" type="password"/>
</div>
...
<div class="px-8 py-4 bg-gray-50 dark:bg-gray-800/50 border-t border-gray-200 dark:border-gray-700 text-center flex-shrink-0">
<p class="text-xs text-gray-500 dark:text-gray-400">
                        By signing up, you agree to our <a class="underline hover:text-primary" href="#">Terms</a> and <a class="underline hover:text-primary" href="#">Privacy Policy</a>.
                    </p>
</div>
</div>
</div>
