...
@error('Username') <span class="text-xs text-red-500">{{ $message }}</span> @enderror
                                ...
                                <div>
                                    ...
                                    <input name="Kota" class="w-full rounded-lg border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-800 text-gray-900 dark:text-white focus:ring-primary focus:border-primary transition-shadow" type="text" value="{{ Auth::user()->Kota ?? '' }}" placeholder="e.g. Jakarta, Bandung"/>
                                    @error('Kota') <span class="text-xs text-red-500">{{ $message }}</span> @enderror
                                </div>
<div class="md:col-span-2">
