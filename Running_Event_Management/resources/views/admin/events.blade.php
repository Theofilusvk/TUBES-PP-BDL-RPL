        ...
        <div class="flex items-center gap-4">
            <form method="GET" action="{{ route('admin.events') }}" class="flex items-center gap-3">
                ...
                <div class="relative group">
                    ...
                    <input name="search" value="{{ request('search') }}" class="bg-surface-dark border border-border-dark rounded-xl pl-12 pr-6 py-2.5 text-sm focus:ring-1 focus:ring-primary focus:border-primary w-64 transition-all text-white placeholder:text-slate-600" placeholder="Search events by name..." type="text"/>
                </div>
            </form>
